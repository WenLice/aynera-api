...
namespace Elaris.Domain.Suggestions.Validators;

public sealed class SubmitSuggestionRequestValidator : AbstractValidator<SubmitSuggestionRequest>
{
    public SubmitSuggestionRequestValidator()
    {
