...
public sealed class RequestMemberReactivationRequestValidator : AbstractValidator<RequestMemberReactivationRequest>
{
    public RequestMemberReactivationRequestValidator()
    {
