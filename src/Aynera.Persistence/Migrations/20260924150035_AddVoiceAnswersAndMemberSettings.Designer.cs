...
namespace Aynera.Persistence.Migrations
{
    ...
    [Migration("20260924150035_AddVoiceAnswersAndMemberSettings")]
    partial class AddVoiceAnswersAndMemberSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aynera.Persistence.Entities.MemberRegistrationDraft", b =>
                {
                    b.HasOne("Aynera.Persistence.Entities.AppUser", "User")
                        .WithOne()
                        .HasForeignKey("Aynera.Persistence.Entities.MemberRegistrationDraft", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
